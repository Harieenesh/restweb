    ...
    <body>
        ...
        <section class="admin-dashboard">
            ...
            <div class="admin-team">
                ...
                <!-- Admin 2 -->
                <div class="admin-card">
                    <img src="Admin 2.jpeg" alt="Admin 2">
                    <h3>Jane Smith</h3>
                ...
                <!-- Admin 3 -->
                <div class="admin-card">
                    <img src="Admin 3.jpeg" alt="Admin 3">
                    <h3>Michelle Lee</h3>
                ...
                <!-- Admin 4 -->
                <div class="admin-card">
                    <img src="Admin 4.jpeg" alt="Admin 4">
                    <h3>Sarah Brown</h3>
                ...
                <!-- Admin 5 -->
                <div class="admin-card">
                    <img src="Admin 5.jpeg" alt="Admin 5">
                    <h3>Jenah White</h3>
...
<html lang="en">
    ...
    <body>
        ...
        <section class="cta-section">
            <div class="cta-card">
                <img src="images (2).jpeg" alt="images (2)">
                <h3>Our Menu</h3>
            ...
            <div class="cta-card">
                <img src="reservation.jpeg" alt="reservation">
    ...
    <body>
        ...
        <section class="menu-section">
            ...
            <div class="menu-items">
                ...
                <!-- Dish 2 -->
                <div class="menu-item">
                    <img src="download (4).jpeg" alt="download (4)">
                    <h3>Caesar Salad</h3>
                    <p>Fresh romaine lettuce with creamy Caesar dressing, croutons, and parmesan.</p>
                </div>
                <!-- Dish 3 -->
                <div class="menu-item">
                    <img src="download (5).jpeg" alt="download (5)">
                    <h3>Steak Frites</h3>
...
## OUTPUT:
![alt text](<Screenshot 2024-12-26 115659.png>)
![alt text](<Screenshot 2024-12-26 115724.png>)
![alt text](<Screenshot 2024-12-26 115745.png>)
![alt text](<Screenshot 2024-12-26 115813.png>)
![alt text](<Screenshot 2024-12-26 115848.png>)
## RESULT:
